...
cell_prune = code(
    ...
    'metrics = {\n'
    '    "Q-Value (QK-Align >= 0.25)": pruning_engine.generate_static_masks(metric="q_value", threshold=0.25),\n'
    '    "Head Redundancy (Corr <= 0.14)": pruning_engine.generate_static_masks(metric="redundancy", threshold=0.14),\n'
    '    "Attention Entropy (Ent <= 0.5)": pruning_engine.generate_static_masks(metric="entropy", threshold=0.5),\n'
    '    "Spike Bern Entropy (Ent >= 0.45)": pruning_engine.generate_static_masks(metric="spike_entropy", threshold=0.45),\n'
    '}\n'
    '\n'
